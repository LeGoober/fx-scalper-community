# ICT 2022 Mentorship model — raid, shift, FVG (v2, draft)

Liquidity is raided, displacement breaks the short-term structure the other way and leaves a fair value gap; enter on the return to the first FVG inside the New York killzone, stop beyond the raid, target the opposing liquidity. v2 fixes the premium/discount range; drafted from keyword-retrieved transcript passages (episodes 1-21); Jev-tagged digest refinement pending.
...
flowchart TD
  ...
  premium_discount["<b>CODE</b> Entry in daily discount / premium"]
...
| 6 | **Entry in daily discount / premium** | code | Longs enter at or below 50% of the previous NY trading day's high-low range (discount); shorts at or above 50% (premium). v1 measured this on the displacement leg, which contradicts entering at the FVG created at the structure break. | [2022 ICT Mentorship Episode 10 @4:09](https://www.youtube.com/watch?v=S9ORTYmXwdE&t=249s) |
